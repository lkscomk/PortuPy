...
class App:
    def __init__(self, master=None):
        ...
        self.tela.title(f'PortuPy (beta - V.0.5) - Nenhum arquivo aberto')
    ...
    def abrirDocumentacao(self, event=None):
        webbrowser.open("https://github.com/lkscomk/doc-portupy/blob/main/README.md")
    ...
    def codificarParaPython(self, *args):
        ...
        if not self.arquivoSalvo:
            self.tela.title(f'*PortuPy (beta - V.0.5) - {str(self.arquivo)}* ')
